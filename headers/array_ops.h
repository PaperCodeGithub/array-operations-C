...
void sort_array(array *arr){
    for(int i = 0; i < arr->size - 1; i++){
        for(int j = 0; j < arr->size - i - 1; j++){
            ...
            switch(arr->type){
                case TYPE_INT:
                    if(((int*)arr->data)[j] > ((int*)arr->data)[j + 1]){
                        int temp = ((int*)arr->data)[j];
                        ((int*)arr->data)[j] = ((int*)arr->data)[j + 1];
                        ((int*)arr->data)[j + 1] = temp;
                        swap = 1;
                    }
                    break;
                case TYPE_FLOAT:
                    if(((float*)arr->data)[j] > ((float*)arr->data)[j + 1]){
                        float temp = ((float*)arr->data)[j];
                        ((float*)arr->data)[j] = ((float*)arr->data)[j + 1];
                        ((float*)arr->data)[j + 1] = temp;
                        swap = 1;
                    }
                    break;
                case TYPE_DOUBLE:
                    if(((double*)arr->data)[j] > ((double*)arr->data)[j + 1]){
                        double temp = ((double*)arr->data)[j];
                        ((double*)arr->data)[j] = ((double*)arr->data)[j + 1];
                        ((double*)arr->data)[j + 1] = temp;
                        swap = 1;
                    }
                    break;
                case TYPE_CHAR:
                    if(((char*)arr->data)[j] > ((char*)arr->data)[j + 1]){
                        char temp = ((char*)arr->data)[j];
                        ((char*)arr->data)[j] = ((char*)arr->data)[j + 1];
                        ((char*)arr->data)[j + 1] = temp;
                        swap = 1;
                    }
                    break;
                case TYPE_STRING:
                    if(strcmp(((char**)arr->data)[j], ((char**)arr->data)[j + 1]) > 0){
                        char *temp = ((char**)arr->data)[j];
                        ((char**)arr->data)[j] = ((char**)arr->data)[j + 1];
                        ((char**)arr->data)[j + 1] = temp;
                        swap = 1;
